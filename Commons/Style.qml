...
QtObject {
  ...
  // component follows the fontconfig alias `quickshell-font-set` writes.
  ...
  // alias path keeps working when the user runs `quickshell font set`), but
  ...
  // Resolve the fontconfig alias to a concrete family name. `quickshell font
  ...
  // `quickshell toggle window-gaps` creates/removes this flag file. Hyprland
