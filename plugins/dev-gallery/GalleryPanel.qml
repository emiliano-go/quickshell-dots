...
// Visual reference + live playground for quickshell-shell's common UI
// components. Summon with `quickshell dev ui-preview`, or directly via:
//   quickshell-shell shell summon quickshell.dev-gallery "{}"
//
...
Item {
  ...
  function open(payloadJson) {
    ...
    // Optional { section: "button" } in the payload lets `quickshell dev
  ...
  function requestClose() {
    if (shell && typeof shell.hide === "function") shell.hide("quickshell.dev-gallery")
  ...
  FloatingWindow {
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("quickshell.dev-gallery")
    }
      ...
      PanelKeyCatcher {
        ...
        Column {
          ...
          Column {
            ...
            Text {
              text: "Quickshell shell · dev gallery"
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `quickshell font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["quickshell.clock", "quickshell.weather", "quickshell.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "quickshell.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "quickshell-menu", label: "Quickshell menu", description: "Launcher / system menu" },
