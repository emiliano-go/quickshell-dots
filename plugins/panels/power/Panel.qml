...
Panel {
  ...
  function setProfile(profile) {
    ...
    actionProc.command = ["quickshell-powerprofiles-set", root.discharging ? "battery" : "ac", profile]
  ...
  Process {
    id: batteryProc
    command: ["quickshell-battery-status", "--shell"]
    stdout: StdioCollector { waitForEnd: true; onStreamFinished: root.updateKeyValue(text, "battery") }
  }

  Process {
    id: profilesProc
    command: ["quickshell-powerprofiles-list", "--active-state"]
