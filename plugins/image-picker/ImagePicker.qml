...
Item {
  ...
  // Injected by quickshell-shell; defaults to the session QUICKSHELL_PATH.
  property string quickshellPath: Quickshell.env("QUICKSHELL_PATH")
  property string stateHome: Quickshell.env("HOME") + "/.local/state"
  property string imageDirs: Quickshell.env("QUICKSHELL_IMAGE_SELECTOR_DIRS") || Quickshell.env("QUICKSHELL_IMAGE_SELECTOR_DIR") || Quickshell.env("QUICKSHELL_STOCK_BACKGROUNDS_DIR") || (stateHome + "/quickshell/current/theme/backgrounds")
  property string imageRows: ""
  property string loadedImageRows: ""
  property string selectionFile: Quickshell.env("QUICKSHELL_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("QUICKSHELL_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("QUICKSHELL_IMAGE_SELECTOR_SELECTED")
  ...
  function scriptPath(name) {
    return quickshellPath + "/shell/plugins/image-picker/" + name
  }
  ...
  // Lifecycle hooks invoked by quickshell-shell summon/hide. shell.summon(id,
